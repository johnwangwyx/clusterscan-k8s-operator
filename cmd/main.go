...
import (
	...
	"github.com/johnwangwyx/clusterscan-k8s-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(johnwangwyxiov1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2856dc30.io.github.johnwangwyx",
