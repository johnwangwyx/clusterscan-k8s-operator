...
func (in *ClusterScanSpec) DeepCopyInto(out *ClusterScanSpec) {
	*out = *in
	if in.JobParams != nil {
		in, out := &in.JobParams, &out.JobParams
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterScanTargets) DeepCopyInto(out *ClusterScanTargets) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterScanTargets.
func (in *ClusterScanTargets) DeepCopy() *ClusterScanTargets {
	if in == nil {
		return nil
	}
	out := new(ClusterScanTargets)
	in.DeepCopyInto(out)
	return out
}
